...
public class TileController : MonoBehaviour
{
    ...
    //generate id masing-masing tiles
    private void Awake()
    {
    ...
    //fungsi untuk cek tile tetangga biar cuma bisa digeser disekitar aja ga jauh-jauh
    #region Adjacent
